...
import PPA from "../src/assets/Screen Shot 2022-09-16 at 1.35.42 PM.png";
          ...
          <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
            ...
            <Col md={4} className="project-card">
              <ProjectCard
                ...
                description=" This is a landing page for a start up company. This page was built using Figma and Editor X. "
                link="https://pocketpropertiesapp.com"
                link1=""
              />
            </Col>
          </Row>
